...
git branch /// - cоздание ветки ///- имя ветки

giе сheckout /// -  переход между ветками ///- имя ветки

git merge /// - объединение веток., когда мы в мастер ветке

git branch -d /// - удаление ветки, где  ///- имя ветки
